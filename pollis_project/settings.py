"""
Django settings for pollis_project project.
...
SECRET_KEY = 'django-insecure-d1x3e_94enkqbe(mlq-0^7(3im@f%mua^tp67_klqknw%u5az8'
...
ROOT_URLCONF = 'pollis_project.urls'
...
WSGI_APPLICATION = 'pollis_project.wsgi.application'
